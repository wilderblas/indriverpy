...
def esPantallaOfreceTuTarifa(texto):
    d = u2.connect()
                        ...
                        if root is not None:
                            ...
                            if distancia_metros<6500:
                                if duracion_minutos < 7 and duracion_minutos > 5.20:
                                    ...
                                    precioAceptado=round(duracion_minutos*0.67)
                                ...
                                if distancia_metros<8000:
                                    precioAceptado=round(duracion_minutos*0.65)
                                    if propuestaSol>=precioAceptado:
...
def get_ui_hierarchy():
    ...
    with open('ui_dump2.xml', 'w', encoding='utf-8') as file:
...
while True:
    try:
        esPantallaOfreceTuTarifa("Ofrece tu tarifa")
    except Exception as e:
        print(f"Ocurrió un error: {e}")
        break
